...
$srcPath = "C:\Users\Admin\.gemini\antigravity-ide\brain\3fa11c5c-0f37-441d-8a6d-83cb2885b397\.user_uploaded\media_1789282096392.png"
$destPath = "C:\laragon\www\demo_son_mai\public\images\layers\layer_06_hoan_thien.png"
...
$W = $srcBmp.Width
$H = $srcBmp.Height
Write-Host "Source Image 6 size: $W x $H"
...
if ($hasPixel) {
    $w = $maxX - $minX + 1
    $h = $maxY - $minY + 1
    Write-Host "Tight trim Image 6: X=$minX, Y=$minY, W=$w, H=$h"
    ...
    Write-Host "Saved high-res layer_06_hoan_thien.png successfully!"
} else {
    $bmp.Dispose()
}
